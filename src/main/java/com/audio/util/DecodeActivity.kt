...
//        DecodeUtil.decodeAudio(path,pathTaret,0,10,callback)
        ...
        var path = Environment.getExternalStorageDirectory().absolutePath + File.separator + "temp/春晓.mp3"//"temp/姑娘我爱你.mp3"
        var pathTaret = Environment.getExternalStorageDirectory().absolutePath + File.separator + "temp/春晓.pcm"//"temp/姑娘我爱你${System.currentTimeMillis()}.pcm"
        DecodeUtil.decodeAudio(path, pathTaret, 0, -10, callback)
...
//        ConvertUtil.convertPcm2Wav2(path,pathTaret)
        ...
        var path = Environment.getExternalStorageDirectory().absolutePath + File.separator + "temp/春晓.pcm"//"temp/姑娘我爱你1610210733753.pcm"
        var pathTaret = Environment.getExternalStorageDirectory().absolutePath + File.separator + "temp/春晓.wav"//"temp/姑娘我爱你convert${System.currentTimeMillis()}.wav"
        ConvertUtil.convertPcm2WavBitNum16(path, pathTaret)//ConvertUtil.convertPcm2WavBitNum8(path, pathTaret)
