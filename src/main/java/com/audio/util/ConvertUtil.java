...
public class ConvertUtil {
     ...
     */
    public static void convertPcm2WavBitNum16(String inPcmFilePath, String outWavFilePath) {
        convertPcm2WavBitNum16(inPcmFilePath, outWavFilePath, Constant.ExportSampleRate,
     ...
     * @param outWavFilePath
     */
    public static void convertPcm2WavBitNum8(String inPcmFilePath, String outWavFilePath) {
        convertPcm2WavBitNum16(inPcmFilePath, outWavFilePath, Constant.ExportSampleRate,
     ...
     */
    public static void convertPcm2WavBitNum16(String inPcmFilePath, String outWavFilePath, int sampleRate,
